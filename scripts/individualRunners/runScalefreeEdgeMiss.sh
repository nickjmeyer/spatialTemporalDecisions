...
## run sims
${EXEC_PATH}/runM1MlesMiss --srcDir ${TOY}/scalefree100 ${EDGE}

${EXEC_PATH}/runM1MlesMiss --srcDir ${TOY}/scalefree500 ${EDGE}

${EXEC_PATH}/runM1MlesMiss --srcDir ${TOY}/scalefree1000 ${EDGE}

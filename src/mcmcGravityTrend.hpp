#ifndef GRAVITY_TREND_MCMC_HPP__
#define GRAVITY_TREND_MCMC_HPP__
...
class GravityTrendSamples{
 public:
  int numSamples;
  int numBurn;
  int numCovar;

  std::vector<double> intcp,beta,alpha,power,trend,trtPre,trtAct;
  std::vector<double> intcpHist,betaHist,alphaHist,powerHist,trendHist,trtPreHist,trtActHist;
...
inline void GravityTrendMcmc::updateAlphaW(std::vector<double> & alphaW,
					   const double & alphaOld,
					   const double & alphaNew,
					   const int numNodes){
...
inline void GravityTrendMcmc::updateCovarBeta(std::vector<double> & covarBeta,
					      const std::vector<double> & covar,
					      const std::vector<double> & beta,
					      const int numNodes,
					      const int numCovar){

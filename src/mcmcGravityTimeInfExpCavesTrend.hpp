#ifndef GRAVITY_TIME_INF_EXP_CAVES_TREND_MCMC_HPP__
#define GRAVITY_TIME_INF_EXP_CAVES_TREND_MCMC_HPP__
...
class GravityTimeInfExpCavesTrendSamples{
 public:
  int numSamples;
  int numBurn;
  int numCovar;

  std::vector<double> intcp,beta,alpha,power,trend,xi,trtPre,trtAct;
  std::vector<double> intcpHist,betaHist,alphaHist,powerHist,trendHist,xiHist,trtPreHist,trtActHist;
...
class GravityTimeInfExpCavesTrendMcmc{
 public:
  ...
  // MCMC samples
  GravityTimeInfExpCavesTrendSamples samples;
...
inline
void GravityTimeInfExpCavesTrendMcmc::updateAlphaW(std::vector<double> & alphaW,
						   const double & alphaOld,
						   const double & alphaNew,
						   const int numNodes){
...
inline
void GravityTimeInfExpCavesTrendMcmc
...
inline
void
GravityTimeInfExpCavesTrendMcmc

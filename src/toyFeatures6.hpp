#ifndef TOY_FEATURES_6_HPP__
#define TOY_FEATURES_6_HPP__
...
class ToyFeatures6TuneParam : public TuneParam {
 public:
...
template<class M>
class ToyFeatures6 : public BaseFeatures<M> {
 public:

#ifndef GRAVITY_TIME_INF_EXP_CAVES_MCMC_HPP__
#define GRAVITY_TIME_INF_EXP_CAVES_MCMC_HPP__
...
class GravityTimeInfExpCavesSamples{
 public:
  int numSamples;
int numBurn;
  int numCovar;
...
std::vector<double> intcpBurn,betaBurn,alphaBurn,powerBurn,xiBurn,trtPreBurn,trtActBurn;
...
class GravityTimeInfExpCavesMcmc{
 public:
  ...
  // MCMC samples
  GravityTimeInfExpCavesSamples samples;

#ifndef MODEL_PARAM_GRAVITY_TIME_INF_EXP_L_CAVES_HPP__
#define MODEL_PARAM_GRAVITY_TIME_INF_EXP_L_CAVES_HPP__
...
class GravityTimeInfExpLCavesParam : public BaseParam {
 public:

#ifndef GRAVITY_TIME_INF_EXP_CAVES_TREND_POW_CON_MCMC_HPP__
#define GRAVITY_TIME_INF_EXP_CAVES_TREND_POW_CON_MCMC_HPP__
...
class GravityTimeInfExpCavesTrendPowConSamples{
 public:
  int numSamples;
  int numBurn;
  int numCovar;

  std::vector<double> intcp,beta,alpha,power,trend,trendPowCon,xi,trtPre,trtAct;
  std::vector<double> intcpHist,betaHist,alphaHist,powerHist,trendHist,trendPowConHist,xiHist,trtPreHist,trtActHist;
...
class GravityTimeInfExpCavesTrendPowConMcmc{
 public:
  ...
  // MCMC samples
  GravityTimeInfExpCavesTrendPowConSamples samples;
  ...
  std::vector<double> timeInfExpCaves; // time infected valued
  ...
  std::vector<double> xiTimeInfExpCaves_cur;
  std::vector<double> xiTimeInfExpCaves_can;
  ...
  inline static void updateCovarBeta(std::vector<double> & covarBeta,
				     ...
				     const int numCovar);
  inline
  static void updateXiTimeInfExpCaves(std::vector<double> & xiTimeInfExpCaves,
				      const double & scale);
};
...
inline
void GravityTimeInfExpCavesTrendPowConMcmc
::updateXiTimeInfExpCaves(std::vector<double> & xiTimeInfExpCaves,
			  const double & scale){
  std::for_each(xiTimeInfExpCaves.begin(),xiTimeInfExpCaves.end(),

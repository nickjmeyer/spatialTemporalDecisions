#ifndef GRAVITY_TIME_INF_TREND_POW_CON_MCMC_HPP__
#define GRAVITY_TIME_INF_TREND_POW_CON_MCMC_HPP__
...
class GravityTimeInfTrendPowConSamples{
 public:
  int numSamples;
  int numBurn;
  int numCovar;
...
class GravityTimeInfTrendPowConMcmc{
 public:
  ...
  // MCMC samples
  GravityTimeInfTrendPowConSamples samples;
...
inline void GravityTimeInfTrendPowConMcmc

...
template class ToyFeatures0<ModelGravity>;

template class ToyFeatures0<ModelTime>;

template class ToyFeatures0<ModelTimeExpCaves>;

template class ToyFeatures0<ModelRadius>;

template class ToyFeatures0<ModelDist>;

template class ToyFeatures0<ModelDistKern>;

template class ToyFeatures0<ModelCovar>;



template <class M>
void ToyFeatures0<M>::preCompData(const SimData & sD,
				  const TrtData & tD,
				  const FixedData & fD,
...
template <class M>
void ToyFeatures0<M>::getFeatures(const SimData & sD,
				  const TrtData & tD,
				  const FixedData & fD,
				  const DynamicData & dD,
				  M & m){
...
template <class M>
void ToyFeatures0<M>::updateFeatures(const SimData & sD,
				     const TrtData & tD,
				     const FixedData & fD,
				     const DynamicData & dD,
				     M & m){

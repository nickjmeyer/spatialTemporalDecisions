#ifndef GRAVITY_TIME_INF_EXP_TREND_POW_MCMC_HPP__
#define GRAVITY_TIME_INF_EXP_TREND_POW_MCMC_HPP__
...
class GravityTimeInfExpTrendPowSamples{
 public:
  int numSamples;
int numBurn;
  int numCovar;
...
class GravityTimeInfExpTrendPowMcmc{
 public:
  ...
  // MCMC samples
  GravityTimeInfExpTrendPowSamples samples;
...
inline void GravityTimeInfExpTrendPowMcmc
...
inline
void GravityTimeInfExpTrendPowMcmc

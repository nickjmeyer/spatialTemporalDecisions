...
ModelTimeExpCavesGDistTrend::ModelTimeExpCavesGDistTrend(const FixedData & fD)
  : ModelBase("TimeExpCavesGDistTrend",genPars(),fD){
}
...
ModelTimeExpCavesGDistTrend &
ModelTimeExpCavesGDistTrend::operator=(const ModelTimeExpCavesGDistTrend & m){
  if(this != & m){
    this->ModelTimeExpCavesGDistTrend::~ModelTimeExpCavesGDistTrend();
    new (this) ModelTimeExpCavesGDistTrend(m);
  }
  return *this;
}
...
double
ModelTimeExpCavesGDistTrend::tuneTrt(const FixedData & fD){
  int i,j;
  double avgCaves = 0.0;
...
void
ModelTimeExpCavesGDistTrend::fit(const SimData & sD, const TrtData & tD,
...
void ModelTimeExpCavesGDistTrend::fit(const SimData & sD, const TrtData & tD,
				      const FixedData & fD,
  ...
  if(fitType == MLE || fitType == MLES){
    ...
    ModelTimeExpCavesGDistTrendFitData dat(*this,all,fD,history);
    ...
    minex_func.n=dim;
    minex_func.f=&modelTimeExpCavesGDistTrendFitObjFn;
    ...
    std::cout << "Error: ModelTimeExpCavesGDistTrend::fit(): MCMC not setup"
	      << std::endl;
    throw(1);
  }
  else{
...
ModelTimeExpCavesGDistTrendFitData
...
modelTimeExpCavesGDistTrendFitObjFn (const gsl_vector * x, void * params){
  ModelTimeExpCavesGDistTrendFitData * dat =
    static_cast<ModelTimeExpCavesGDistTrendFitData*> (params);

#ifndef GRAVITY_TIME_INF_SQ_MCMC_HPP__
#define GRAVITY_TIME_INF_SQ_MCMC_HPP__
...
class GravityTimeInfSqMcmc{
 public:
  ...
  // MCMC samples
  GravityTimeInfSqSamples samples;
  ...
  std::vector<double> xiTimeInfSq_cur;
  std::vector<double> xiTimeInfSq_can;
  ...
  inline static void updateCovarBeta(std::vector<double> & covarBeta,
				     ...
				     const int covarInd,
				     const int numCovar);
  inline static void updateXiTimeInfSq(std::vector<double> & xiTimeInfSq,
				       const double & scale);
};



inline void GravityTimeInfSqMcmc::updateAlphaW(std::vector<double> & alphaW,
					       const double & alphaOld,
					       const double & alphaNew,
					       const int numNodes){
...
inline
void GravityTimeInfSqMcmc::updateCovarBeta(std::vector<double> & covarBeta,
					   const std::vector<double> & covar,
					   const std::vector<double> & beta,
					   const int numNodes,
					   const int numCovar){
...
inline
void GravityTimeInfSqMcmc::updateXiTimeInfSq(std::vector<double> & xiTimeInfSq,
					     const double & scale){
  std::for_each(xiTimeInfSq.begin(),xiTimeInfSq.end(),

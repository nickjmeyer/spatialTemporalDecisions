#ifndef MODEL_PARAM_GRAVITY_TIME_INF_EXP_R_CAVES_HPP__
#define MODEL_PARAM_GRAVITY_TIME_INF_EXP_R_CAVES_HPP__
...
class GravityTimeInfExpRCavesParam : public BaseParam {
 public:

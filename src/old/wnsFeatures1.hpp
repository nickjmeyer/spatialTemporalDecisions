#ifndef WNS_FEATURES_1_HPP__
#define WNS_FEATURES_1_HPP__
...
class WnsFeatures1TuneParam : public TuneParam {
 public:
...
template<class M>
class WnsFeatures1 : public BaseFeatures<M> {
 public:

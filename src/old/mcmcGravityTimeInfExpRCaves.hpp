#ifndef GRAVITY_TIME_INF_EXP_R_CAVES_MCMC_HPP__
#define GRAVITY_TIME_INF_EXP_R_CAVES_MCMC_HPP__
...
class GravityTimeInfExpRCavesSamples{
 public:
  int numSamples;
  int numCovar;
...
class GravityTimeInfExpRCavesMcmc{
 public:
  ...
  // MCMC samples
  GravityTimeInfExpRCavesSamples samples;
  ...
  std::vector<double> timeInfExpRCaves; // time infected valued
  ...
  std::vector<double> xiTimeInfExpRCaves_cur;
  std::vector<double> xiTimeInfExpRCaves_can;
  ...
  inline static void updateCovarBeta(std::vector<double> & covarBeta,
				     ...
				     const int numCovar);
  inline
  static void updateXiTimeInfExpRCaves(std::vector<double> & xiTimeInfExpRCaves,
				       const double & scale);
};
...
inline
void GravityTimeInfExpRCavesMcmc::updateAlphaW(std::vector<double> & alphaW,
					       const double & alphaOld,
					       const double & alphaNew,
					       const int numNodes){
...
inline
void
GravityTimeInfExpRCavesMcmc::updateCovarBeta(std::vector<double> & covarBeta,
					     const std::vector<double> & covar,
					     const std::vector<double> & beta,
					     const int numNodes,
					     const int numCovar){
...
inline
void GravityTimeInfExpRCavesMcmc
::updateXiTimeInfExpRCaves(std::vector<double> & xiTimeInfExpRCaves,
			   const double & scale){
  std::for_each(xiTimeInfExpRCaves.begin(),xiTimeInfExpRCaves.end(),

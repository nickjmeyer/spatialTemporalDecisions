#ifndef GRAVITY_TIME_INF_EXP_L_CAVES_MCMC_HPP__
#define GRAVITY_TIME_INF_EXP_L_CAVES_MCMC_HPP__
...
class GravityTimeInfExpLCavesSamples{
 public:
  int numSamples;
  int numCovar;
...
class GravityTimeInfExpLCavesMcmc{
 public:
  ...
  // MCMC samples
  GravityTimeInfExpLCavesSamples samples;
  ...
  std::vector<double> timeInfExpLCaves; // time infected valued
  ...
  std::vector<double> xiTimeInfExpLCaves_cur;
  std::vector<double> xiTimeInfExpLCaves_can;
  ...
  inline static void updateCovarBeta(std::vector<double> & covarBeta,
				     ...
				     const int numCovar);
  inline
  static void updateXiTimeInfExpLCaves(std::vector<double> & xiTimeInfExpLCaves,
				       const double & scale);
};
...
inline
void GravityTimeInfExpLCavesMcmc::updateAlphaW(std::vector<double> & alphaW,
					       const double & alphaOld,
					       const double & alphaNew,
					       const int numNodes){
...
inline
void
GravityTimeInfExpLCavesMcmc::updateCovarBeta(std::vector<double> & covarBeta,
					     const std::vector<double> & covar,
					     const std::vector<double> & beta,
					     const int numNodes,
					     const int numCovar){
...
inline
void GravityTimeInfExpLCavesMcmc
::updateXiTimeInfExpLCaves(std::vector<double> & xiTimeInfExpLCaves,
			   const double & scale){
  std::for_each(xiTimeInfExpLCaves.begin(),xiTimeInfExpLCaves.end(),

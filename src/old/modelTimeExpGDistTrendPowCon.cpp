#include "modelTimeExpGDistTrendPowCon.hpp"
...
ModelTimeExpGDistTrendPowCon::ModelTimeExpGDistTrendPowCon(const FixedData & fD)
  : ModelBase("TimeExpGDistTrendPowCon",genPars(),fD){
}
...
ModelTimeExpGDistTrendPowCon &
ModelTimeExpGDistTrendPowCon::operator=(const ModelTimeExpGDistTrendPowCon & m){
  if(this != & m){
    this->ModelTimeExpGDistTrendPowCon::~ModelTimeExpGDistTrendPowCon();
    new (this) ModelTimeExpGDistTrendPowCon(m);
  }
  return *this;
}
...
double
ModelTimeExpGDistTrendPowCon::tuneTrt(const FixedData & fD){
  int i,j;
  double avgCaves = 0.0;
...
void
ModelTimeExpGDistTrendPowCon::fit(const SimData & sD, const TrtData & tD,
...
void ModelTimeExpGDistTrendPowCon::fit(const SimData & sD, const TrtData & tD,
				       const FixedData & fD,
  ...
  if(fitType == MLE || fitType == MLES){
    ...
    ModelTimeExpGDistTrendPowConFitData dat(*this,all,fD,history);
    ...
    minex_func.n=dim;
    minex_func.f=&modelTimeExpGDistTrendPowConFitObjFn;
    ...
    std::cout << "Error: ModelTimeExpGDistTrendPowCon::fit(): MCMC not setup"
	      << std::endl;
    throw(1);
  }
  else{
...
ModelTimeExpGDistTrendPowConFitData
...
modelTimeExpGDistTrendPowConFitObjFn (const gsl_vector * x, void * params){
  ModelTimeExpGDistTrendPowConFitData * dat =
    static_cast<ModelTimeExpGDistTrendPowConFitData*> (params);

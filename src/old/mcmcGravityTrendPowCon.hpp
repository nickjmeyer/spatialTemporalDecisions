#ifndef GRAVITY_TREND_POW_CON_MCMC_HPP__
#define GRAVITY_TREND_POW_CON_MCMC_HPP__
...
int numBurn;
  ...
  std::vector<double> intcp,beta,alpha,power,trend,trendPowCon,trtPre,trtAct;
std::vector<double> intcpBurn,betaBurn,alphaBurn,powerBurn,trendBurn,trendPowConBurn,trtPreBurn,trtActBurn;
...
class GravityTrendPowConMcmc{
 public:
  ...
  // MCMC samples
  GravityTrendPowConSamples samples;
...
inline void GravityTrendPowConMcmc::updateAlphaW(std::vector<double> & alphaW,
						 const double & alphaOld,
						 const double & alphaNew,
						 const int numNodes){
...
inline void GravityTrendPowConMcmc

#ifndef GRAVITY_TIME_INF_EXP_TREND_POW_CON_MCMC_HPP__
#define GRAVITY_TIME_INF_EXP_TREND_POW_CON_MCMC_HPP__
...
class GravityTimeInfExpTrendPowConSamples{
 public:
  int numSamples;
int numBurn;
  int numCovar;
...
class GravityTimeInfExpTrendPowConMcmc{
 public:
  ...
  // MCMC samples
  GravityTimeInfExpTrendPowConSamples samples;
  ...
  std::vector<double> timeInfExp; // time infected valued
  ...
  std::vector<double> xiTimeInfExp_cur;
  std::vector<double> xiTimeInfExp_can;
...
inline void GravityTimeInfExpTrendPowConMcmc
...
inline
void GravityTimeInfExpTrendPowConMcmc

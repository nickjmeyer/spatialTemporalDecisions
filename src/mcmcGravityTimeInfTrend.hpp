#ifndef GRAVITY_TIME_INF_TREND_MCMC_HPP__
#define GRAVITY_TIME_INF_TREND_MCMC_HPP__
...
class GravityTimeInfTrendSamples{
 public:
  int numSamples;
  int numBurn;
  int numCovar;
...
class GravityTimeInfTrendMcmc{
 public:
  ...
  // MCMC samples
  GravityTimeInfTrendSamples samples;
...
inline void GravityTimeInfTrendMcmc::updateAlphaW(std::vector<double> & alphaW,
						  const double & alphaOld,
						  const double & alphaNew,
						  const int numNodes){
...
inline void GravityTimeInfTrendMcmc
...
inline
void GravityTimeInfTrendMcmc::updateCovarBeta(std::vector<double> & covarBeta,
					      const std::vector<double> & covar,
					      const std::vector<double> & beta,
					      const int numNodes,
					      const int numCovar){
...
inline
void GravityTimeInfTrendMcmc::updateXiTimeInf(std::vector<double> & xiTimeInf,
					      const double & scale){

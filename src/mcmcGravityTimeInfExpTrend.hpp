#ifndef GRAVITY_TIME_INF_EXP_TREND_MCMC_HPP__
#define GRAVITY_TIME_INF_EXP_TREND_MCMC_HPP__
...
class GravityTimeInfExpTrendSamples{
 public:
  int numSamples;
int numBurn;
  int numCovar;
...
class GravityTimeInfExpTrendMcmc{
 public:
  ...
  // MCMC samples
  GravityTimeInfExpTrendSamples samples;
...
inline void GravityTimeInfExpTrendMcmc
...
inline
void GravityTimeInfExpTrendMcmc

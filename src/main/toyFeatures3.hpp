#ifndef TOY_FEATURES_3_HPP__
#define TOY_FEATURES_3_HPP__
...
class ToyFeatures3TuneParam : public TuneParam {
 public:
...
template<class M>
class ToyFeatures3 : public BaseFeatures<M> {
 public:

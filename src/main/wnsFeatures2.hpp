#ifndef WNS_FEATURES_2_HPP__
#define WNS_FEATURES_2_HPP__
...
class WnsFeatures2TuneParam : public TuneParam {
 public:
...
template<class M>
class WnsFeatures2 : public BaseFeatures<M> {
 public:
